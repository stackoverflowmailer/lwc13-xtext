...
CG2013 task. We will extend the grammar later to meet all requirements. With
...
Java-style Identifiers (beginning with character followed by any character,
...
Finally, the Question rule is defined. In a first step, Questions are identified
...
refer to Java types. The JvmTypeReference rule is also inherited through Xbase,
